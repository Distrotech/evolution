...
void em_utils_compose_new_message (struct _CamelFolder *folder);

/* FIXME: mailto?  url?  should make up its mind what its called.  imho use 'uri' */
void em_utils_compose_new_message_with_mailto (struct _CamelFolder *folder, const char *url);
...
void em_utils_forward_message (struct _CamelFolder *folder, struct _CamelMimeMessage *msg);

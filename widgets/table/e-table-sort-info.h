...
const ETableSortColumn *e_table_sort_info_grouping_get_nth   (ETableSortInfo *info, int n);
void                    e_table_sort_info_grouping_set_nth   (ETableSortInfo *info, int n, const char *name, gboolean ascending);
...
const ETableSortColumn *e_table_sort_info_sorting_get_nth    (ETableSortInfo *info, int n);
void                    e_table_sort_info_sorting_set_nth    (ETableSortInfo *info, int n, const char *name, gboolean ascending);
